...
public class Programa20 {
	...
	/*
	 * Uma função deve ter o seguinte: a)Tipo de retorno (Tipo de dado que a
	 * função vai retornar); b)Nome - Corresponde a ação que a função realiza;
	 * c)Parâmetros/Argumentos de entrada (Opcional); d)Retorno (Opcional) -
